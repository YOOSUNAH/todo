...
public class TodoController {
    ...
    public TodoResponseDto updateMemo(HttpServletRequest request, @PathVariable Long todoId, @RequestBody TodoRequestDto todoRequestDto){
        return todoService.updateTodo(request, todoId, todoRequestDto);
    }
